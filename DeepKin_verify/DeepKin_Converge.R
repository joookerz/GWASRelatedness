...
gear_path = "~/Desktop/project_management/tools/gear"
bfileprefix = "/Users/joookerz/Desktop/project_management/GWASrelatedness/data/converge/CONVERGE_slim"
...
KING = readBin("/Users/joookerz/Desktop/project_management/GWASrelatedness/data/converge/deepkin_converge.king.bin" , what="numeric", n=56610120,size=4)

deepkin$king[1:10000]
KING[1:10000]

plot(deepkin$king[1:100000] , 2*KING[1:100000])
abline(a=0 , b=1 , )

eigenval = read.table("/Users/joookerz/Desktop/project_management/GWASrelatedness/data/converge/PCA.eigenval")

eigenvec = read.table("/Users/joookerz/Desktop/project_management/GWASrelatedness/data/converge/PCA.eigenvec", header = T)
